            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-6">
                {[
                  ...
                  {
                    icon: LinkedInIcon,
                    value: t.contact.socialMedia.linkedin,
                    label: t.contact.socialMedia.title,
                    link: "https://www.linkedin.com/company/talent-in-om/",
                    gradient: "from-blue-600 to-blue-700",
                  },
                  {
                    icon: WhatsAppIcon,
                    value: t.contact.socialMedia.whatsapp,
                    label: t.contact.socialMedia.title,
                    link: "http://wa.me/96897511711",
